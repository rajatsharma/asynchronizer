...
var _express = _interopRequireDefault(__webpack_require__(123));

var _compression = _interopRequireDefault(__webpack_require__(325));

var _bodyParser = _interopRequireDefault(__webpack_require__(326));

var _ping = _interopRequireDefault(__webpack_require__(327));

var _config = _interopRequireDefault(__webpack_require__(328));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Initialize the Express App
const app = new _express.default(); // Apply body Parser and server public assets and routes
...
app.listen(_config.default.port, error => {
  ...
  console.log(`Server running at ${_config.default.port}`);
});
var _default = app;
...
router.route('/').get((req, res) => {
  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.next = 2;
        return regeneratorRuntime.awrap(Promise.resolve('Server Working Fine'));
